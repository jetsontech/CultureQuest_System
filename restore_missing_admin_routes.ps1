...
Write-Host " Restore Missing Admin Routes" -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan
Write-Host ""
...
'@ | Set-Content .\_restore_admin_routes.py -Encoding utf8

python .\_restore_admin_routes.py

Write-Host ""
Write-Host "Done." -ForegroundColor Green
Write-Host "Now restart with:" -ForegroundColor Yellow
